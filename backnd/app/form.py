...
class HelperForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['first_name', 'middle_name', 'last_name', 'primary_phone', 'secondary_phone',
                  'email_id', 'dob', 'street', 'city', 'zipcode', 'state', 'country', 'work_experience',
                  'availability_status', 'availability_status_week', 'additional_comment', 'photo',
        ...
        widgets = {
            ...
            'primary_phone': forms.TextInput(
                attrs={'class': 'form-control my-2', 'maxlength': '10', 'pattern': '[1-9]{1}[0-9]{9}',
            ...
            'photo': forms.FileInput(
                attrs={'class': 'form-control my-2', 'accept': '.jpeg', 'required': 'required', 'rows': '2'}),
            'id_pdf': forms.FileInput(
                attrs={'class': 'form-control my-2', 'accept': '.pdf', 'required': 'required', 'rows': '2'}),
        ...
        labels = {
            ...
            'photo': " <b class='mb-4'>Photo upload (jpeg)[max 5mb] </b>",
        }
...
class HelperEditForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['first_name', 'middle_name', 'last_name', 'primary_phone', 'secondary_phone',
                  'email_id', 'dob', 'street', 'city', 'zipcode', 'state', 'country', 'work_experience',
                  'availability_status', 'availability_status_week', 'photo',
        ...
        widgets = {
            ...
            'dob': forms.DateInput(attrs={'class': 'form-control my-2', 'type': 'date', 'rows': '2'}),
            'photo': forms.FileInput(
                attrs={'class': 'form-control my-2', 'accept': '.jpeg', 'rows': '2'}),
