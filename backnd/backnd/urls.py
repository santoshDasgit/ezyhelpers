...
urlpatterns = [
    ...
    path('excel_file_locality_upload',ExcelFileLocalityFileView,name='excel_file_locality_upload'),
    path('excel_file_skill_upload',ExcelFileSkillsFileView,name='excel_file_skill_upload'),
    path('job_category_upload',ExcelFilejob_category_upload,name='job_category_upload'),
    path('job_category_Edit_View/<id>',job_categoryEditView,name='job_category_Edit_View'),
        path('job_category_add_View',job_categoryaddView,name='job_categoryaddView'),
    path('job_category_delete/<id>',job_categoryDeleteView,name='job_category_delete'),
